...
namespace ExemploDapperOracle.Infra
{
	public class DataContext
	{
		...
		{
			//var connectionString = @"Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT=1521)))(CONNECT_DATA=(SID=xe)));User ID=system;Password=Rede@!2018";
